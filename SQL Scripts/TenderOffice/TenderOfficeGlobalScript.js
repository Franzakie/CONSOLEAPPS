...
=====================================================================================================================================================
    ...
    Modified Date: 7 November 2016
	Version Number:Tender Office - V7.3.8.xml
=====================================================================================================================================================
*/
...
function EvaluateChanges()
{
    ...
    try
    {
        ...
        RFQType = Fields["7355322.15:Type of RFQ"].Value;
        receivedDate = Fields["7355322.15:Received Date"].Value;     
        ClosedeDate = Fields["7355322.15:Closing Date"].Value;       
        receivedTime = Fields["7355322.15:Received Time"].Value;     
        ClosedeTime = Fields["7355322.15:Closing Time"].Value;       
        ...
        if(RFQType == "Invalid")
        {
            Fields["7355322.15:Status"].Value = "";
        ...
        {
            Fields["7355322.15:Status"].Value = "On-time";
            Fields["7355322.15:SAP Update"].Value = "5";
        }

        if(Fields["7355322.15:Send to Buyer"].Value == "Yes")
        {
            Fields["7355322.15:Status"].Value = "Review Required";
            Fields["7355322.15:SAP Update"].Value = "90";
        }

        Context["ReceivedDate"] = Fields["7355322.15:Received Date"].Value;
        Context["ReceivedTime"] = Fields["7355322.15:Received Time"].Value;
        Context["RFQType"] = Fields["7355322.15:Type of RFQ"].Value;
        Context["SendToBuyer"] = Fields["7355322.15:Send to Buyer"].Value;
        Context["UpdateInSap"] = Fields["7355322.15:SAP Update"].Value;
    }
    catch (Exception)
    {
...
function UpdateTables()
{
    ...
    try
    {
        ...
        rfqNo = Document["Indexing:7355322.15:RFQ Number:0"];
        src = Document["Indexing:7355322.15:Source:0"];
        strRFQPrice = Document["Indexing:7355322.15:RFQ Amount:0"];
        conn.Open();
        cmd.Connection = conn;
    ...
    */
    ...
    try
    {
        ...
        */
        ...
        Fields["7355322.15:Collective Number"].ReadOnly = true;
        Fields["7355322.15:Material Number"].ReadOnly = true;
        Fields["7355322.15:Location No"].ReadOnly = true;
        Fields["7355322.15:Location"].ReadOnly = true;
        Fields["7355322.15:Closing Date"].ReadOnly = true;
        Fields["7355322.15:Closing Time"].ReadOnly = true;
        Fields["7355322.15:Vendor Number"].ReadOnly = true;
        Fields["7355322.15:Vendor Name"].ReadOnly = true;
        //Fields["7355322.15:Source"].ReadOnly = true;
        Fields["7355322.15:Buyer No"].ReadOnly = true;
        Fields["7355322.15:Buyer Name"].ReadOnly = true;
        //Fields["7355322.15:Buyer e-mail"].ReadOnly = true;
        Fields["7355322.15:Scan Pc"].ReadOnly = true;
        Fields["7355322.15:Scan Date"].ReadOnly = true;
        Fields["7355322.15:SAP Update"].ReadOnly = true;
        Fields["7355322.15:Created Date"].ReadOnly = true;
        Fields["Information"].ReadOnly = true;
        Fields["7355322.15:Status"].ReadOnly = true;
        /*
        ====================================
        Check invalid RFQ
        ====================================
        ...
        else
        {
            ...
            */
            ...
            if(src == "Fax")
            {
                ...
                Fields["7355322.15:Created Date"].Value = scandate;
                Fields["7355322.15:Created Date"].ReadOnly = true;

                Fields["7355322.15:Received Date"].Value = scandate;
                Fields["7355322.15:Received Time"] = scandate.ToString("HH:mm");
            }
			Err = "2"
            ...
            */
            ...
            if (dr.Read())
            {
				...
				myFormat = System.Threading.Thread.CurrentThread.CurrentCulture.DateTimeFormat; 
 				var myDate	= Fields["7355322.15:Closing Date"].Value;
				...
				strInformation = year + ":" + arr[1] + ":" + arr[2] + ":" + Fields["7355322.15:Collective Number"].Value;
                if(src == "Fax")
                {
